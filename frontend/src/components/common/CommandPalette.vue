        ...
        >
          <div class="border-b border-border p-3">
            <input
              ...
              v-model="query"
              type="search"
              class="w-full rounded-md border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-ring"
